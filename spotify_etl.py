...
schedule.every(10).seconds.do(api_to_json)
schedule.every(10).seconds.do(recent_tracks)
schedule.every(10).seconds.do(valid_data)
schedule.every(10).seconds.do(create_db)
